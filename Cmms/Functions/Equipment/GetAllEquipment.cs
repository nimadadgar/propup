...
namespace Cmms
{
    ...
    public class GetAllEquipment
    {
        ...
        public GetAllEquipment(ILoggerFactory loggerFactory,
        ...
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.Anonymous, "post",Route = "equipment/getall")]
        HttpRequestData req,
            ...
            FunctionContext executionContext)
        {
            ...
            var result = await  _equipmentService.GetAll(requestObject.Value);
